...
# Load the sample data and tree from the old ps object
...
tax.ps <- tax %>%
    ...
    as_matrix %>% 
    tax_table
ps.reads <- phyloseq(st, sam, tree, tax.ps)
# saveRDS(ps.reads, file.path(data_path, 
#         prepend_date("phase3_phyloseq_reads.Rds")))
# [1] "2018-05-22_phase3_phyloseq_reads.Rds"
```
