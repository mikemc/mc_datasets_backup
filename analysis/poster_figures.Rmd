...
evaluation samples only. Using log base 10 so that distances can be connected
to the step plot.
```{r, fig.height = 6}
set.seed(2)
ggplot(tb3, aes(Calibrated, Distance / log2(10), color = Protocol)) +
...
Using log base 10 so that distances can be connected to the step plot.
```{r, fig.height = 6, fig.width = 8}
