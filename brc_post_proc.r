...
tax <- readRDS(file.path(data.path, 'brc_dada_out', "taxonomy.rds"))
# species <- readRDS(file.path(data.path, 'brc_dada_out', "species.rds"))
...
### Saved the filtered ps object, as this is what we will work with for now
